...
def turn_right():
    ...
    # if not move_leg_interpolated(LEG3_IDS, 3, GAIT_SEQ_1_REVERSE[0], duration=power_duration): return
    ...
    print("Moving Leg 2 (REVERSE Power 0->1) + Leg 3 (REVERSE Return 3->4)...")
    # if not move_legs_interpolated_sync([
    #     # {'ids': LEG2_IDS, 'leg_num': 2, 'target_pos': GAIT_SEQ_1_REVERSE[3]},
    ...
    time.sleep(0.5)
    # if not move_leg_interpolated(LEG2_IDS, 2, GAIT_SEQ_1_REVERSE[0], duration=power_duration): return
    ...
    # if not move_leg_interpolated(LEG4_IDS, 4, GAIT_SEQ_1_REVERSE[0], duration=power_duration): return
    time.sleep(0.5)
    # Leg 2 나머지 REVERSE Power
    # if not move_leg_interpolated(LEG2_IDS, 2, GAIT_SEQ_1_REVERSE[2], duration=power_duration): return
    # if not move_legs_interpolated_sync([
